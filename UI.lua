if game.CoreGui:FindFirstChild("MOKURO GUI") then
    game.CoreGui:FindFirstChild("MOKURO GUI"):Destroy()
end
local DiscordLib = {}
...
Discord.Name = "MOKURO GUI"
Discord.Parent = game.CoreGui
Discord.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function DiscordLib:Window(text,mainclr,cls)
    local PresetColor = mainclr or Color3.fromRGB(0, 255, 0)
    local CloseBind = cls or Enum.KeyCode.RightControl
    ...
    local OutLayFrameGradient = Instance.new("UIGradient")
    ...
    OutLayFrame.Name = "OutLayFrame"
    OutLayFrame.Parent = MainFrame
    OutLayFrame.BackgroundTransparency = 0
    OutLayFrame.Position = UDim2.new(0, 0, 0, 18)
    OutLayFrame.Size = UDim2.new(0, 614, 0, 378)
    OutLayFrame.BackgroundColor3 = PresetColor

	OutLayFrameCorner.CornerRadius = UDim.new(0, 7)
    OutLayFrameCorner.Name = "OutLayFrameCorner"
    OutLayFrameCorner.Parent = OutLayFrame
    ...
    function ServerHold:Server(text, img)
        ...
        function ChannelHold:Channel(text,ico)
            ...
            ChannelBtn.Position = UDim2.new(0, 1, 0.03761, 0)
            ...
            function ChannelContent:Seperator()
                ...
                Seperator1.BackgroundColor3 = PresetColor
                ...
                Seperator2.BackgroundColor3 = PresetColor
            ...
            function ChannelContent:Dropdown(text, list, callback)
                ...
                DropdownFrame.Position = UDim2.new(0.00899999978, 0, 1.06638527, 0)
